...
(function () {
  ...
  const translations = {
    en: {
      ...
      'home.about.p1': 'I am currently a Lecturer at the School of Intelligent Imaging Engineering, Beijing Film Academy. I received my PhD from Beijing Institute of Technology (BIT) and was a visiting PhD student at Universitat Politècnica de Catalunya (UPC). My research focuses on Crowd Simulation, Virtual Reality, and Human-Computer Interaction.',
      ...
      'home.news.date.siggraphAsia': 'Sep 09, 2026',
      'home.news.date.bfa': 'Sep 2026',
      ...
      'home.news.badge.paper': 'Paper',
      'home.news.badge.talk': 'Talk',
      'home.news.badge.misc': 'Misc',
      'home.news.siggraphAsia': 'Our work <em>Becoming the Traveler: Reweaving a Thousand-Year Ink Landscape into an Immersive VR World</em> has been accepted as a <strong>Poster at SIGGRAPH Asia 2026</strong>.',
      'home.news.bfa': 'Joined the <strong>School of Intelligent Imaging Engineering, Beijing Film Academy</strong> as a <strong>Lecturer</strong>.',
      ...
      'home.footer.updated': 'Last updated September 2026.',
      ...
      'publications.intro': '<strong><u>Bold underline</u></strong> = Kexiang Huang. &nbsp; † Corresponding author. &nbsp; Full list on <a href="https://scholar.google.com/citations?user=77A6XHMAAAAJ" target="_blank" rel="noopener noreferrer">Google Scholar</a>.',
    ...
    zh: {
      ...
      'home.about.p1': '我现任北京电影学院智能影像工程学院讲师。我已获得 Beijing Institute of Technology (BIT) 博士学位，并曾在 Universitat Politècnica de Catalunya (UPC) 进行博士访学。我的研究方向包括人群仿真、虚拟现实与人机交互。',
      ...
      'home.news.title': '动态',
      'home.news.date.siggraphAsia': '2026 年 9 月 9 日',
      'home.news.date.bfa': '2026 年 9 月',
      ...
      'home.news.badge.paper': '论文',
      'home.news.badge.talk': '报告',
      'home.news.badge.misc': '其他',
      'home.news.siggraphAsia': '我们的工作 <em>Becoming the Traveler: Reweaving a Thousand-Year Ink Landscape into an Immersive VR World</em> 被 <strong>SIGGRAPH Asia 2026 Poster</strong> 接收。',
      'home.news.bfa': '加入<strong>北京电影学院智能影像工程学院</strong>，担任<strong>讲师</strong>。',
      ...
      'home.footer.updated': '最后更新于 2026 年 9 月。',
      ...
      'publications.intro': '<strong><u>加粗下划线</u></strong>表示黄可翔。&nbsp; † 通讯作者。&nbsp; 完整列表请见 <a href="https://scholar.google.com/citations?user=77A6XHMAAAAJ" target="_blank" rel="noopener noreferrer">Google Scholar</a>。',
